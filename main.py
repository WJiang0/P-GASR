...
def model_supervisor(args):
    ...
    # AL pipeline
    pe_weights1 = p_gasr.infer_policy(mode='pre-train1')

    pe_weights2 = p_gasr.infer_policy(mode='pre-train2')

    pe_weights_list.extend(pe_weights2)
    pe_weights_list.extend(pe_weights1)

    p_gasr.re_train(pe_weights_list)
