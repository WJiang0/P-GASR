...
from lib.metrics import mae_torch, mae_torch2
...
def masked_mae_loss2(mask_value):
    def loss(preds, labels, pe_weight):
        mae = mae_torch2(pred=preds, true=labels, pe_weight=pe_weight, mask_value=mask_value)
        return mae
    return loss
